...
class TestCaseSerializer(serializers.ModelSerializer):
    ...
    creator_name = serializers.CharField(source='creator.nickname', read_only=True, allow_null=True)
    assignee_name = serializers.CharField(source='assignee.nickname', read_only=True, allow_null=True)
    updater_name = serializers.CharField(source='updater.nickname', read_only=True, allow_null=True)
